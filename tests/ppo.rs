#[cfg(test)]
mod tests {
    use technical_analysis::indicators::{Indicator, PPOOutput, PercentagePriceOscillator};
    ...
    fn test_default_ppo() {
        ...
        let inputs = vec![
            ...
            IndicatorValue::from(103.0),
            IndicatorValue::from(104.0),
            IndicatorValue::from(105.0),
            IndicatorValue::from(106.0),
            IndicatorValue::from(107.0),
            IndicatorValue::from(108.0),
            IndicatorValue::from(109.0),
            IndicatorValue::from(110.0),
            IndicatorValue::from(111.0),
            IndicatorValue::from(112.0),
            IndicatorValue::from(113.0),
            IndicatorValue::from(114.0),
            IndicatorValue::from(115.0),
            IndicatorValue::from(116.0),
            IndicatorValue::from(117.0),
            IndicatorValue::from(118.0),
            IndicatorValue::from(119.0),
            IndicatorValue::from(120.0),
            IndicatorValue::from(121.0),
            IndicatorValue::from(122.0),
            IndicatorValue::from(123.0),
            IndicatorValue::from(124.0),
            IndicatorValue::from(125.0),
            IndicatorValue::from(126.0),
            IndicatorValue::from(127.0),
            IndicatorValue::from(128.0),
            IndicatorValue::from(129.0),
            IndicatorValue::from(130.0),
            IndicatorValue::from(131.0),
            IndicatorValue::from(132.0),
            IndicatorValue::from(133.0),
            IndicatorValue::from(134.0),
        ];
    ...
    fn test_ppo_edge_case_small_periods() {
        ...
        let inputs = vec![IndicatorValue::from(100.0), IndicatorValue::from(102.0)];
    ...
    fn test_ppo_edge_case_identical_inputs() {
        ...
        let inputs = vec![IndicatorValue::from(100.0); 50];
        ...
        for i in 34..inputs.len() {
            assert_eq!(
                ppo.next(inputs[i]).map(|output| PPOOutput {
                    ppo_value: output.ppo_value.round_dp(2),
                    signal_value: output.signal_value.round_dp(2),
                    histogram_value: output.histogram_value.round_dp(2),
                }),
