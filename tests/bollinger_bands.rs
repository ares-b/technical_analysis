#[cfg(test)]
mod tests {
    use technical_analysis::indicators::{BollingerBands, Indicator};
    ...
    fn test_bollinger_bands_next() {
        ...
        assert_eq!(result.middle_band.round_dp(2), IndicatorValue::from(22.79));
    ...
    fn test_bollinger_bands_with_constant_prices() {
        ...
        assert_eq!(result.middle_band, IndicatorValue::from(50.0));
    ...
    fn test_bollinger_bands_with_increasing_prices() {
        ...
        assert_eq!(result.middle_band.round_dp(2), IndicatorValue::from(10.50));
