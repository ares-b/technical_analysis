...
mod tests {
    ...
    fn test_vwap_next() {
        ...
        let result = vwap.next((
            IndicatorValue::from(22.39),
            IndicatorValue::from(22.31),
            IndicatorValue::from(22.38),
            IndicatorValue::from(2000.0),
        ));
    ...
    fn test_vwap_reset() {
        let mut vwap = VolumeWeightedAveragePrice::new();
        let data = vec![(22.27, 22.19, 22.25, 2000.0), (22.29, 22.21, 22.28, 1500.0)]
            .into_iter()
            .map(|(h, l, c, v)| {
                (
                    IndicatorValue::from(h),
