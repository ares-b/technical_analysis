#[cfg(test)]
mod tests {
    use technical_analysis::indicators::{AverageTrueRange, Indicator};
    ...
    fn test_atr() {
        ...
        assert_eq!(
            atr.next((
                IndicatorValue::from(46.78),
                IndicatorValue::from(46.34),
                IndicatorValue::from(46.43)
            )),
            None
        );
        assert_eq!(
            atr.next((
                IndicatorValue::from(47.32),
                IndicatorValue::from(46.64),
                IndicatorValue::from(46.87)
            )),
            None
        );
        assert_eq!(
            atr.next((
                IndicatorValue::from(47.45),
                IndicatorValue::from(46.43),
                IndicatorValue::from(46.76)
            )),
            None
        );
    }
    ...
    fn test_atr_next() {
        ...
        let result = atr
            .next((
                IndicatorValue::from(22.55),
                IndicatorValue::from(21.47),
                IndicatorValue::from(22.65),
            ))
            .unwrap();
