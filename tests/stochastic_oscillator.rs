...
mod tests {
    ...
    fn test_stochastic_oscillator_basic() {
        ...
        let output = stoch.next((
            IndicatorValue::from(10.0),
            IndicatorValue::from(5.0),
            IndicatorValue::from(7.0),
        ));
        assert!(output.is_none());

        let output = stoch.next((
            IndicatorValue::from(15.0),
            IndicatorValue::from(6.0),
            IndicatorValue::from(9.0),
        ));
        assert!(output.is_none());
    ...
    fn test_stochastic_oscillator_next_chunk() {
        ...
        let data = [
            (
                IndicatorValue::from(127.01),
                IndicatorValue::from(125.36),
                IndicatorValue::from(126.63),
            ),
            (
                IndicatorValue::from(126.59),
                IndicatorValue::from(124.93),
                IndicatorValue::from(125.54),
            ),
            (
                IndicatorValue::from(126.82),
                IndicatorValue::from(125.72),
                IndicatorValue::from(126.30),
            ),
            (
                IndicatorValue::from(127.14),
                IndicatorValue::from(126.09),
                IndicatorValue::from(126.82),
            ),
            (
                IndicatorValue::from(128.23),
                IndicatorValue::from(126.64),
                IndicatorValue::from(127.91),
            ),
        ];
